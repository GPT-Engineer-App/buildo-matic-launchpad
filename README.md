...
**Project**: buildo-matic-launchpad 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Please recreate this page

Add a button that says: Start building. Start building should take me to a new page: /build. Also create the new page. 
...
```sh
git clone https://github.com/GPT-Engineer-App/buildo-matic-launchpad.git
cd buildo-matic-launchpad
npm i
